...
public class MovieController {
    ...
    public MovieController(MovieService movieService, UserRepository userRepository, EmailService emailService) {
    ...
    public ResponseEntity<MovieDto> addMovieHandler(@RequestPart MultipartFile file,
        ...
        if (!userEmails.isEmpty()) {
            emailService.sendNotificationToAllUsers(userEmails, savedMovie.getTitle());
        }
